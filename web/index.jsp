...
<%--<body>--%>
<%--<p>This is a landing page for my Spring Web MVC project.</p>--%>
<%--<p>FIT5042 Lab 07</p>--%>
<%--<a href="${pageContext.request.contextPath}/hello">Click Here to access the HelloController</a>--%>
<%--</body>--%>
<section class="hero">
  <div class="background-image"></div>
  <div class="hero-content-area">
    <h1>Spring MVC</h1>
    <h3>This is a landing page for my Spring Web MVC project. FIT5042 LAB 07</h3>
    <a href="${pageContext.request.contextPath}/hello" class="btn">Access the HelloController</a>
  </div>
</section>
</html>
